# Consolidated GUIDES Documentation

**Generated**: 2025-08-07 22:01:45  
**Purpose**: Consolidated documentation from multiple service-specific documents  
**Consolidation Type**: guides  
**Services Covered**: grafana/certs,keycloak,redis,vault-agent

## Overview

This document consolidates similar guides documentation from multiple services to eliminate 
...
**Original Location**: /opt/dev-purebliss/services/vault-agent/README.md
...
**Source Document**: README.md  
**Original Location**: /opt/dev-purebliss/services/grafana/certs/README.md

#### Place tls.crt and tls.key here for HTTPS enablement.


### keycloak Service

**Source Document**: README.md  
**Original Location**: /opt/dev-purebliss/services/keycloak/README.md
...
**Source Document**: README.md  
**Original Location**: /opt/dev-purebliss/services/redis/README.md
