...
migrate_core_scripts() {
    ...
    safe_move "/opt/dev-purebliss/validate-container-health.sh" "$CENTRAL_REPO/core/validate-container-health.sh"
    safe_move "/opt/dev-purebliss/upstream-validation.sh" "$CENTRAL_REPO/core/upstream-validation.sh"
    safe_move "/opt/dev-purebliss/container-scaffold.sh" "$CENTRAL_REPO/core/container-scaffold.sh"
    safe_move "/opt/dev-purebliss/start-all-services.sh" "$CENTRAL_REPO/core/start-all-services.sh"
    safe_move "/opt/dev-purebliss/start-all.sh" "$CENTRAL_REPO/core/start-all.sh"
    ...
    safe_move "/opt/dev-purebliss/start-purebliss-orchestrator.sh" "$CENTRAL_REPO/core/start-purebliss-orchestrator.sh"
}
...
migrate_automation_scripts() {
    ...
    # Automation scripts
    safe_move "/opt/dev-purebliss/container-cleanup.sh" "$CENTRAL_REPO/automation/container-cleanup.sh"
    safe_move "/opt/dev-purebliss/enhance-container-with-vault.sh" "$CENTRAL_REPO/automation/enhance-container-with-vault.sh"
    safe_move "/opt/dev-purebliss/auto-executable-manager.sh" "$CENTRAL_REPO/automation/auto-executable-manager.sh"
    safe_move "/opt/dev-purebliss/container-config-generator.sh" "$CENTRAL_REPO/automation/container-config-generator.sh"
    safe_move "/opt/dev-purebliss/script-enhancements-keycloak-containers.sh" "$CENTRAL_REPO/automation/script-enhancements-keycloak-containers.sh"
}
...
migrate_service_scripts() {
    ...
    # Vault scripts
    safe_move "/opt/dev-purebliss/setup-vault.sh" "$CENTRAL_REPO/services/vault/setup-vault.sh"
    ...
    safe_move "/opt/dev-purebliss/deploy-nginx-enhanced.sh" "$CENTRAL_REPO/services/nginx/deploy-nginx-enhanced.sh"
    safe_move "/opt/dev-purebliss/enhance-nginx-vault-integration.sh" "$CENTRAL_REPO/services/nginx/enhance-nginx-vault-integration.sh"
    safe_move "/opt/dev-purebliss/test-nginx-independent-startup.sh" "$CENTRAL_REPO/services/nginx/test-nginx-independent-startup.sh"

    # Keycloak scripts
    safe_move "/opt/dev-purebliss/deploy-keycloak.sh" "$CENTRAL_REPO/services/keycloak/deploy-keycloak.sh"
    safe_move "/opt/dev-purebliss/fix-keycloak-database-auth.sh" "$CENTRAL_REPO/services/keycloak/fix-keycloak-database-auth.sh"
    safe_move "/opt/dev-purebliss/simple-keycloak-auth-fix.sh" "$CENTRAL_REPO/services/keycloak/simple-keycloak-auth-fix.sh"
    ...
    safe_move "/opt/dev-purebliss/independent-keycloak-dependency-test.sh" "$CENTRAL_REPO/services/keycloak/independent-keycloak-dependency-test.sh"
...
migrate_utility_scripts() {
    ...
    safe_move "/opt/dev-purebliss/health-validation-integration-example.sh" "$CENTRAL_REPO/health-checks/health-validation-integration-example.sh"
    ...
    safe_move "/opt/dev-purebliss/reboot-sanity.sh" "$CENTRAL_REPO/health-checks/reboot-sanity.sh"
    ...
    safe_move "/opt/dev-purebliss/validate-service-dependencies.sh" "$CENTRAL_REPO/utilities/validate-service-dependencies.sh"
    safe_move "/opt/dev-purebliss/independent-service-testing.sh" "$CENTRAL_REPO/utilities/independent-service-testing.sh"
    safe_move "/opt/dev-purebliss/scaffold-build.sh" "$CENTRAL_REPO/utilities/scaffold-build.sh"
}
