...
SCRIPT_NAME="redis-full-validation.sh"
...
redis_full_validation_log_info() {
    local message="$1"
...
redis_full_validation_log_error() {
    local message="$1"
...
redis_full_validation_log_success() {
    local message="$1"
