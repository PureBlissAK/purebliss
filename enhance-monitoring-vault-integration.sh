...
function enhance_grafana() {
    ...
    if [[ -x "/opt/dev-purebliss/enhance-container-with-vault.sh" ]]; then
        /opt/dev-purebliss/enhance-container-with-vault.sh grafana monitoring_config
    else
...
function enhance_prometheus() {
    ...
    if [[ -x "/opt/dev-purebliss/enhance-container-with-vault.sh" ]]; then
        /opt/dev-purebliss/enhance-container-with-vault.sh prometheus monitoring_config
    else
        log_error "Universal enhancement script not found"
        return 1
    fi
...
function enhance_loki() {
    ...
    if [[ -x "/opt/dev-purebliss/enhance-container-with-vault.sh" ]]; then
        /opt/dev-purebliss/enhance-container-with-vault.sh loki monitoring_config
    else
        log_error "Universal enhancement script not found"
        return 1
    fi
