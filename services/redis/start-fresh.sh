...
if [[ -f "/opt/dev-purebliss/dev_scripts/health-checks/comprehensive-health-check.sh" ]]; then
    log_action "Running system health check"
    if /opt/dev-purebliss/dev_scripts/health-checks/comprehensive-health-check.sh redis 2>/dev/null; then
...
echo "  System health check: /opt/dev-purebliss/dev_scripts/health-checks/comprehensive-health-check.sh redis"
echo ""
